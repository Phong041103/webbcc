...
// Lấy ID đơn hàng từ session hoặc URL
$order_id = isset($_SESSION['order_id']) ? $_SESSION['order_id'] : (isset($_GET['order_id']) ? intval($_GET['order_id']) : 0);
            ...
            <div class="table-responsive">
                <form action="../vnpay/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        <label for="language">Hóa Đơn </label>
                    ...
                    <div class="form-group">
                        ...
                        name="amount" type="number" value="<?php echo $order['total'] ; ?>" readonly/>
                    ...
                    <button type="submit" name="redirect" id="redirect" class="btn btn-primart">Thanh toán Redirect</button>
